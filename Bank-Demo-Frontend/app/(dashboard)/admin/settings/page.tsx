...
export default function AdminSettingsPage() {
  // 🚀 true gönderiyoruz çünkü burası Admin!
  const { user, profileForm, setProfileForm, passForm, setPassForm, loadingProfile, loadingPass, handleUpdateProfile, handleChangePassword } = useSettings(true);

  return (
    <div className="max-w-4xl mx-auto space-y-8 p-6">
      <PageHeader title="Yönetici Ayarları" description="Kişisel bilgilerinizi ve yönetici güvenliğinizi buradan yönetin." />
